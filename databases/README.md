...
In this folder you will find some data we work with daily! 

The `create_table.sql` contains create statements for tables required for the exercise.

Data for the tables can be found in `account.csv` and `account_event.csv` if you prefer to import from file.
